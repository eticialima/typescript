...
const resultado_1 = exibirNome('Leticia');
const resultado_2 = exibirNome('Leticia', undefined);
// const resultado_3 = exibirNome('Leticia', 'Lima', 'Senhorita');
const resultado_4 = exibirNome('Leticia', 'Lima');
